...
function up1(){
    if (car_y>=0){
        car_y=car_y-10
        console.log("when w is preased,x= "+car_y+" ,y= "+car_y)
        uploadBackground();
        uploadrover();
        uploadcar();
    }
...
function down1(){
    if (car_y<=500){
        car_y=car_y+10
        console.log("when s is preased,x= "+car_y+" ,y= "+car_y)
        uploadBackground();
        uploadrover();
        uploadcar();
    }
...
function left1(){
    if (car_x>=0){
        car_x=car_x-10
        console.log("when a is preased,x= "+car_x+" ,y= "+car_y)
        uploadBackground();
        uploadrover();
        uploadcar();
    }
...
function right1(){
    if (car_x<=700){
        car_x=car_x+10
        console.log("when d is preased,x= "+car_x+" ,y= "+car_y)
        uploadBackground();
        uploadrover();
        uploadcar();
    }
